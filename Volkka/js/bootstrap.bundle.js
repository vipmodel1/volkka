...
function validarSenha() {
  ...
  // Atualiza as mensagens conforme o usuário digita
  atualizarEstado(minLength, tamanhoMinimo);
  atualizarEstado(uppercase, temMaiuscula);
  atualizarEstado(lowercase, temMinuscula);
  atualizarEstado(number, temNumero);
}
...
//---- JS para aparecer e sumir o menu da página ----
let lastScrollTop = 0;
